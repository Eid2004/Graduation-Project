...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const dnsSpoofBtn = document.getElementById("dns-spoof-btn");
  if (dnsSpoofBtn) {
    dnsSpoofBtn.addEventListener("click", () =>
      runTool(
        "DNS Spoofing Check",
        checkDnsSpoof,
        () => document.getElementById("target-url").value,
  ...
  const pwAnalyzeBtn = document.getElementById("pw-analyze-btn");
  if (pwAnalyzeBtn) {
    pwAnalyzeBtn.addEventListener("click", () => {
    if (isRunning) return;
  ...
  const vtHashBtn = document.getElementById("vt-hash-btn");
  if (vtHashBtn) {
    vtHashBtn.addEventListener("click", () =>
      runTool(
        "VT Hash Check",
        scanHashVirusTotal,
  ...
  const vtUrlBtn = document.getElementById("vt-url-btn");
  if (vtUrlBtn) {
    vtUrlBtn.addEventListener("click", () =>
      runTool(
        "VT URL Scan",
        scanUrlVirusTotal,
        () => document.getElementById("target-url").value,
  ...
  const vtFileBtn = document.getElementById("vt-file-btn");
  if (vtFileBtn) {
    vtFileBtn.addEventListener("click", () =>
      runTool(
        "VT File Scan",
        scanFileVirusTotal,
